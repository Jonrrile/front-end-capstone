        ...
        <Card.Img variant="top"
         ...
         src={props.wishjourney.url}/>
            <Card.Body>
                ...
                <Button className="btn" variant="outline-primary" type="button" onClick={() => props.deleteJourney(props.wishjourney.id)}>Delete</ Button>
               <Button className="btn"  variant="outline-primary" type="button" onClick={() => props.history.push(`/wishlist/${props.wishjourney.id}/edit`)}>Edit</Button>           
                </Card.Body>
                </Card>
    )
}
